...
| 6 | Any table recording which excavator loaded which truck | **No.** No dispatch log, assignment table or loader event log exists in either database. This is why Match Factor cannot key on a shovel. |
